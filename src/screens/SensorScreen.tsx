// src/screens/SensorScreen.tsx - COMPLETE FIXED VERSION
...
import { SensorData, SensorChartData } from '../types';
          ...
          <View style={styles.currentDataCard}>
            ...
            <View style={styles.dataGrid}>
              <View style={styles.dataItem}>
                ...
                <Text style={[styles.dataValue, { color: Theme.chartBodyTemp }]}>
                  {currentSensors.body_temp.toFixed(1)}°C
                </Text>
              </View>
              <View style={styles.dataItem}>
                <Text style={styles.dataLabel}>Heart Rate</Text>
                <Text style={[styles.dataValue, { color: Theme.chartHeartRate }]}>
                  {currentSensors.heart_rate_bpm.toFixed(0)} BPM
                </Text>
              </View>
              <View style={styles.dataItem}>
                <Text style={styles.dataLabel}>SpO2</Text>
                <Text style={[styles.dataValue, { color: Theme.chartSpO2 }]}>
                  {currentSensors.spo2_pct.toFixed(0)}%
                </Text>
              </View>
              <View style={styles.dataItem}>
                <Text style={styles.dataLabel}>Ambient Temp</Text>
                <Text style={[styles.dataValue, { color: Theme.chartAmbientTemp }]}>
